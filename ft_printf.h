...
/*   Updated: 2017/10/10 13:57:55 by klut             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_format_regime(const char *arg_data,
		int i, t_printlist *buffer);
void				*ft_bzero(void *s, size_t n);
int					ft_conv_buffering(const char *arg_data,
		int i, t_printlist *buffer);
...
int					ft_digits_cast_processing(t_printlist *buffer,
		va_list arguments);
int					ft_unsigned_digits_processing(t_printlist *buffer,
		va_list arguments);
int					ft_d_convertion(t_printlist *buffer,
		long long int num);
int					ft_du_convertion(t_printlist *buffer,
		unsigned long int num);
int					ft_memory_type_parc1(t_printlist *buffer, int i);
int					ft_memory_type_parc2(t_printlist *buffer, int i);
char				*ft_dies_proc(t_printlist *buffer,
		char *output, char *number);
char				*ft_space_filler(t_printlist *buffer,
		char *output, char *temp);
char				*ft_precision_filler(t_printlist *buffer,
		char *output, char *number);
char				*ft_zeroproc(char *output, char *number,
		t_printlist *buffer);
char				*ft_zeroprecision(t_printlist *buffer, char *output);
char				*ft_stringproc(t_printlist *buffer, char *string);
char				*ft_dig_output(char *output, char *number,
		t_printlist *buffer);
char				*ft_dig_output_u(char *output, char *number,
		t_printlist *buffer);
char				*ft_dig_output_uo(char *output, char *number,
		t_printlist *buffer);
char				*ft_itoa_base(long long int value, char *str, int base);
char				*ft_itoa_base_u(unsigned long int value,
		char *str, int base);
void				ft_f_ignore_checker_digit(t_printlist *buffer,
		char *number);
...
int					ft_letters_processing(t_printlist *buffer,
		va_list arguments);
